...
public class PassiveUpgradeButtonView : MonoBehaviour
{
    [SerializeField] private GameStateController game;
    [SerializeField] private double defaultCost = 20;
    [SerializeField] private double incomeIncrease = 0.5;
    [SerializeField] private TMP_Text priceText;
    private Button button;

    private double cost;
    private const string CostKey = "PassiveUpgradeCost";
    ...
    private void Awake()
    {
        ...
        button.onClick.AddListener(() =>
        {
            ...
            {
                game.State.UpgradePassive(incomeIncrease);
